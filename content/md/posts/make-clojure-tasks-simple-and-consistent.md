{:title "Make Clojure development tasks simple and consistent"
:layout :post
:date "2022-10-23"
:topic "clojure"
:tags  ["make" "makefile" "clojure" "clojure-cli"]}
...
[GNU Make](https://www.gnu.org/software/make/manual/html_node/Standard-Targets.html) is available on all Linux/Unix based operating systems (and Windows via [chocolatey](https://chocolatey.org/) or nmake).
...
> Reference: [https://makefiletutorial.com/#phony](https://makefiletutorial.com/#phony)
...
> Reference: [https://makefiletutorial.com/#delete_on_error](https://makefiletutorial.com/#delete_on_error)
